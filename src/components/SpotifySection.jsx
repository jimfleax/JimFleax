...
const Flex = styled(motion.div)`
  ...
  border-radius: 10px;
  padding: 20px;
  box-shadow: rgba(166, 166, 166, 0.01) 0px 520px 146px 0px, rgba(196, 196, 196, 0.04) 0px 333px 133px 0px, rgba(172, 172, 172, 0.26) 0px 83px 83px 0px, rgba(161, 161, 161, 0.29) 0px 21px 46px 0px;
